...
public class Paint {
	...
	public Paint(String brand, String colour, int qantity, double price, String type, boolean ecofriendly,
			boolean quality, long mtgdate, long expdate, boolean oilpaint) {
		super();
		this.brand = brand;
		this.colour = colour;
	...
	public String toString() {
		return "Paint [brand=" + brand + ", colour=" + colour + ", qantity=" + qantity + ", price=" + price + ", type="
				+ type + ", ecofriendly=" + ecofriendly + ", quality=" + quality + ", mtgdate=" + mtgdate + ", expdate="
